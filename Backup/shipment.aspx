<%@ Page Language="C#" AutoEventWireup="true" Inherits="shipment" Codebehind="shipment.aspx.cs" %>
        ...
        <uc1:menu ID="menu1" runat="server" />
         ...
         <ContentTemplate>
            <div style="padding:0px 1px;">
                ...
                <td>Invoice#</td><td>
                    <asp:TextBox CssClass="txtbox_small" ID="invoice_no" runat="server" ></asp:TextBox></td>
                <td>Cust PO</td><td>
             ...
             onrowdatabound="GridView1_RowDataBound" ondatabound="GridView1_DataBound" 
                 onsorting="GridView1_Sorting">
                    <Columns>
                        ...
                        <asp:BoundField DataField="PO_NO" HeaderText="Customer PO"  />
                        ...
                        <asp:BoundField DataField="invoice_date" DataFormatString="{0:M/d/yyyy}" HeaderText="Invoice Date" />
                        ...
                        <asp:BoundField DataField="del_qty" DataFormatString="{0:#,###}" 
                            HeaderText="Qty">
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="del_sqft" DataFormatString="{0:#,###.##}" 
                            HeaderText="Sqft">
                        </asp:BoundField>
                        <asp:BoundField DataField="del_amt_usd" HeaderText="Amount" 
                        ...
                        <asp:BoundField DataField="ship_to_customer" HeaderText="Ship To Customer" />
                        <asp:BoundField DataField="salesman" HeaderText="Sales Man" />
                        <asp:BoundField DataField="Segment1" HeaderText="Segment" />
                    </Columns>
                </asp:GridView>
